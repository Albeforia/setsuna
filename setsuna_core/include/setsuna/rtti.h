...
/**
@brief Cast a pointer of @p SourceType to a pointer of @p TargetType
...
Generally you only need to specify @p TargetType :
...
@attention Enabling custom RTTI for a class requires all its base classes have custom RTTI enabled.
*/
